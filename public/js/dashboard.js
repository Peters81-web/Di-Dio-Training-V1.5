            ...
            <div id="completionModal" class="modal">
                <div class="modal-content">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-2xl font-bold">Registra Allenamento: ${workout.name}</h2>
                    ...
                    <form id="completionForm" class="space-y-6">
                        <div>
                            <label class="block text-gray-700 mb-2">Livello di Intensità</label>
                            <select id="intensityLevel" class="w-full px-4 py-2 border rounded-lg" required>
                        ...
                        <div>
                            <label class="block text-gray-700 mb-2">Durata Effettiva (minuti)</label>
                            <input
                                type="number"
                                id="actualDuration"
                        ...
                        <div>
                            <label class="block text-gray-700 mb-2">Calorie Bruciate (stima)</label>
                            <input
                                type="number"
                                id="caloriesBurned"
                                class="w-full px-4 py-2 border rounded-lg"
                        ...
                        <div>
                            <label class="block text-gray-700 mb-2">Note sull'allenamento</label>
                            <textarea
                                id="workoutNotes"
                                class="w-full px-4 py-2 border rounded-lg"
                                rows="3"
                        ...
                        <div class="flex justify-end space-x-4">
                            <button type="button" onclick="closeCompletionModal()" class="px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600">
                                Annulla
                            </button>
